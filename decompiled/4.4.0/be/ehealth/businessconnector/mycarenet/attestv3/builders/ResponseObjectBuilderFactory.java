...
public final class ResponseObjectBuilderFactory {
   ...
   private static ConfigurableFactoryHelper<ResponseObjectBuilder> helperFactoryresponseBuilder = new ConfigurableFactoryHelper<ResponseObjectBuilder>("attestv3.responseobjectbuilder.class", "be.ehealth.businessconnector.mycarenet.attestv3.builders.impl.ResponseObjectBuilderImpl");
