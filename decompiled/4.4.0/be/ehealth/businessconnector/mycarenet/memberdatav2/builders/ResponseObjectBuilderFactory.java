...
public final class ResponseObjectBuilderFactory {
   ...
   private static ConfigurableFactoryHelper<ResponseObjectBuilder> helperFactoryresponseBuilder = new ConfigurableFactoryHelper<ResponseObjectBuilder>("memberdata.responseobjectbuilder.class", "be.ehealth.businessconnector.mycarenet.memberdatav2.builders.impl.ResponseObjectBuilderImpl");
