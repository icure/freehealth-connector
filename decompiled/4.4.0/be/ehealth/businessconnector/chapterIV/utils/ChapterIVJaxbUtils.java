...
public final class ChapterIVJaxbUtils {
   private static MarshallerHelper<FolderType, FolderType> folderTypeMarshaller = new MarshallerHelper<FolderType, FolderType>(FolderType.class, FolderType.class);
   private static MarshallerHelper<Kmehrresponse, Kmehrresponse> kmehrResponseMarshallerHelper = new MarshallerHelper<Kmehrresponse, Kmehrresponse>(Kmehrresponse.class, Kmehrresponse.class);
