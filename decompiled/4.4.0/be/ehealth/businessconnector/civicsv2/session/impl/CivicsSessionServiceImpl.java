...
public class CivicsSessionServiceImpl implements CivicsSessionService, ConfigurationModuleBootstrap.ModuleBootstrapHook {
   ...
   public FindParagraphTextResponse findParagraphText(FindParagraphTextRequest request) throws TechnicalConnectorException {
      return (FindParagraphTextResponse)this.executeOperation(request, "urn:be:fgov:ehealth:civics:service:v2:findParagraphText", FindParagraphTextResponse.class);
   }
   ...
   public GetParagraphExclusionsResponse getParagraphExclusions(GetParagraphExclusionsRequest request) throws TechnicalConnectorException {
      return (GetParagraphExclusionsResponse)this.executeOperation(request, "urn:be:fgov:ehealth:civics:service:v2:getParagraphExclusions", GetParagraphExclusionsResponse.class);
   }
   ...
   public GetParagraphIncludedSpecialtiesResponse getParagraphIncludedSpecialities(GetParagraphIncludedSpecialtiesRequest request) throws TechnicalConnectorException {
      return (GetParagraphIncludedSpecialtiesResponse)this.executeOperation(request, "urn:be:fgov:ehealth:civics:service:v2:getParagraphIncludedSpecialities", GetParagraphIncludedSpecialtiesResponse.class);
   }
   ...
   public GetProfessionalAuthorizationsResponse getProfessionalAuthorizations(GetProfessionalAuthorizationsRequest request) throws TechnicalConnectorException {
      return (GetProfessionalAuthorizationsResponse)this.executeOperation(request, "urn:be:fgov:ehealth:civics:service:v2:getProfessionalAuthorizations", GetProfessionalAuthorizationsResponse.class);
   }

   public GetAddedDocumentsResponse getAddedDocuments(GetAddedDocumentsRequest request) throws TechnicalConnectorException {
      return (GetAddedDocumentsResponse)this.executeOperation(request, "urn:be:fgov:ehealth:civics:service:v2:getAddedDocuments", GetAddedDocumentsResponse.class);
   }
   ...
   public FindReimbursementConditionsResponse findReimbursementConditions(FindReimbursementConditionsRequest request) throws TechnicalConnectorException {
      return (FindReimbursementConditionsResponse)this.executeOperation(request, "urn:be:fgov:ehealth:civics:service:v2:findReimbursementConditions", FindReimbursementConditionsResponse.class);
   }

   public FindParagraphResponse findParagraph(FindParagraphRequest request) throws TechnicalConnectorException {
      return (FindParagraphResponse)this.executeOperation(request, "urn:be:fgov:ehealth:civics:service:v2:findParagraph", FindParagraphResponse.class);
   }

   public FindCNKResponse findCNK(FindCNKRequest request) throws TechnicalConnectorException {
      return (FindCNKResponse)this.executeOperation(request, "urn:be:fgov:ehealth:civics:service:v2:findCNK", FindCNKResponse.class);
   }

   public FindPublicCNKResponse findPublicCNK(FindPublicCNKRequest request) throws TechnicalConnectorException {
      return (FindPublicCNKResponse)this.executeOperation(request, "urn:be:fgov:ehealth:civics:service:v2:findPublicCNK", FindPublicCNKResponse.class);
   }
