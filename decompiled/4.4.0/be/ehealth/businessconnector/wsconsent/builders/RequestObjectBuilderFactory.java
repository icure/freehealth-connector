...
public final class RequestObjectBuilderFactory {
   ...
   private static ConfigurableFactoryHelper<RequestObjectBuilder> helperFactoryRequestObjectBuilder = new ConfigurableFactoryHelper<RequestObjectBuilder>("be.ehealth.businessconnector.wsconsent.builders.RequestObjectBuilder.class", "be.ehealth.businessconnector.wsconsent.builders.impl.RequestObjectBuilderImpl");
   private static ConfigurableFactoryHelper<PatientInfoBuilder> helperFactoryPatientInfoBuilder = new ConfigurableFactoryHelper<PatientInfoBuilder>("wsconsent.patientinfobuilder.class", "be.ehealth.businessconnector.wsconsent.builders.impl.PatientInfoBuilderImpl");
   private static ConfigurableFactoryHelper<HcPartyInfoBuilder> helperFactoryHcPartyInfoBuilder = new ConfigurableFactoryHelper<HcPartyInfoBuilder>("be.ehealth.businessconnector.wsconsent.builders.HcPartyInfoBuilder.class", "be.ehealth.businessconnector.wsconsent.builders.impl.DelegatingHcPartyInfoBuilderImpl");
   private static ConfigurableFactoryHelper<ConsentBuilder> helperFactoryConsentBuilder = new ConfigurableFactoryHelper<ConsentBuilder>("wsconsent.ConsentBuilder.class", "be.ehealth.businessconnector.wsconsent.builders.impl.ConsentBuilderImpl");
   private static ConfigurableFactoryHelper<AuthorBuilder> helperFactoryAuthorBuilder = new ConfigurableFactoryHelper<AuthorBuilder>("be.ehealth.businessconnector.wsconsent.builders.AuthorBuilder.class", "be.ehealth.businessconnector.wsconsent.builders.impl.AuthorBuilderImpl");
   ...
   public static RequestObjectBuilder getRequestObjectBuilder() throws TechnicalConnectorException, WsConsentBusinessConnectorException, InstantiationException {
      return helperFactoryRequestObjectBuilder.getImplementation();
   }

   public static PatientInfoBuilder getPatientInfoBuilder() throws TechnicalConnectorException {
      return helperFactoryPatientInfoBuilder.getImplementation();
   }
