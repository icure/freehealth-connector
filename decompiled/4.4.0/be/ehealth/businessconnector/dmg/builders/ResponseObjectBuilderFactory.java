...
public final class ResponseObjectBuilderFactory {
   ...
   private static ConfigurableFactoryHelper<ResponseObjectBuilder> helperFactoryresponseBuilder = new ConfigurableFactoryHelper<ResponseObjectBuilder>("dmg.responseobjectbuilder.class", "be.ehealth.businessconnector.dmg.builders.impl.ResponseObjectBuilderImpl");
