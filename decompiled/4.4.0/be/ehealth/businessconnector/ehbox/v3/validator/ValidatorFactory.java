...
public final class ValidatorFactory {
   ...
   private static ConfigurableFactoryHelper<EhboxReplyValidator> factory = new ConfigurableFactoryHelper<EhboxReplyValidator>("be.ehealth.businessconnector.ehbox.v3.validator", EhboxReplyValidatorImpl.class.getName());
