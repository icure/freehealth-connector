...
public final class ResponseBuilderFactory {
   ...
   private static ConfigurableFactoryHelper<ResponseBuilder> responseBuilderFactory = new ConfigurableFactoryHelper<ResponseBuilder>("mycarenet.mcn.responseobjectbuilder.class", "be.ehealth.business.mycarenetcommons.builders.impl.ResponseBuilderImpl");
   ...
   public static ResponseBuilder getResponseBuilder(String projectName) throws TechnicalConnectorException {
      ...
      return responseBuilderFactory.getImplementation(configProperties);
   }
}
