...
public final class SessionUtil {
      ...
      if (!sessionMgr.hasValidSession()) {
         ...
         if (attributes != null) {
            for(int i = 0; i < attributes.getLength(); ++i) {
               ...
               String attributeName = attr.getNamedItem("AttributeName").getTextContent();
               String attributeNamespace = attr.getNamedItem("AttributeNamespace").getTextContent();
               if (attributeName.matches(attributeNamePattern) && attributeNamespace.matches(namespacePattern)) {
   ...
   public static Map<String, List<String>> getMatchingAttributes(String attributeNamePattern) throws TechnicalConnectorException {
      return getMatchingAttributes(".*", attributeNamePattern);
   }
