...
public abstract class AbstractWsSecurityHandler extends AbstractSOAPHandler {
   ...
   public WSSecHeaderGeneratorStep0 buildSignature() throws TechnicalConnectorException {
      ConfigurableFactoryHelper<WSSecHeaderGeneratorStep0> helper = new ConfigurableFactoryHelper<WSSecHeaderGeneratorStep0>("be.ehealth.technicalconnector.handler.wssecurity", WSSecHeaderGeneratorWss4jImpl.class.getName());
