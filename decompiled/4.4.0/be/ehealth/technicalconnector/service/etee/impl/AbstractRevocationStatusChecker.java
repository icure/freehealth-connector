...
public abstract class AbstractRevocationStatusChecker implements RevocationStatusChecker, SessionServiceWithCache {
   ...
   public AbstractRevocationStatusChecker() {
      this.cache = CacheFactory.<X509Certificate, Boolean>newInstance(CacheFactory.CacheType.MEMORY, "revocation-cache", CacheInformation.ExpiryType.NONE, (Duration)null);
