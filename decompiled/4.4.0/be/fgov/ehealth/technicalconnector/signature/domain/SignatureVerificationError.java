...
public enum SignatureVerificationError {
   ...
   XADES_ENCAPSULATED_OCSP_NOT_FOUND("Error indication that there was no encapsulated OCSP in the xades-c."),
   XADES_ENCAPSULATED_OCSP_NOT_VERIFIED("Error indication that there was no encapsulated OCSP in the xades-c."),
   XADES_ENCAPSULATED_OCSP_NOT_VALID("Error indication that there was the encapsulated OCSP in the xades-c was invalid."),
