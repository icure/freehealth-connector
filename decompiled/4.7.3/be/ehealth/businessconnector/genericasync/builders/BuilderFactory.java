...
public final class BuilderFactory {
   ...
   private static ConfigurableFactoryHelper<ResponseObjectBuilder> helperFactoryresponseBuilder = new ConfigurableFactoryHelper<ResponseObjectBuilder>("genericasync.responseobjectbuilder.class", "be.ehealth.businessconnector.genericasync.builders.impl.ResponseObjectBuilderImpl");

   private BuilderFactory() {
   }

   private static <T> T getBuilder(BuilderConfig builderConfig, String serviceName) throws TechnicalConnectorException {
      ConfigurableFactoryHelper<T> helper = new ConfigurableFactoryHelper<T>("genericasync." + serviceName + builderConfig.componentName, builderConfig.defaultBuilderClassName);
