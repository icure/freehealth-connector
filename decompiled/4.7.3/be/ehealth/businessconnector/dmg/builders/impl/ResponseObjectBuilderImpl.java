...
public class ResponseObjectBuilderImpl implements ResponseObjectBuilder, ConfigurationModuleBootstrap.ModuleBootstrapHook {
   ...
   private <T extends Serializable> Serializable unmarshallByteContent(byte[] byteArray, Class<T> unmarshallClass) {
      MarshallerHelper<T, T> helper = new MarshallerHelper<T, T>(unmarshallClass, unmarshallClass);
      T jaxbObject = null;
      ...
      try {
         ...
         jaxbObject = (T)(helper.toObject(byteArray));
         return jaxbObject;
   ...
   private <T> MarshallerHelper<T, T> getMarshallerHelper(Object response) throws TechnicalConnectorException {
      ...
      if (response instanceof ConsultGlobalMedicalFileResponse) {
         responseMarshaller = new MarshallerHelper<T, T>(ConsultGlobalMedicalFileResponse.class, ConsultGlobalMedicalFileResponse.class);
      } else if (response instanceof NotifyGlobalMedicalFileResponse) {
         responseMarshaller = new MarshallerHelper<T, T>(NotifyGlobalMedicalFileResponse.class, NotifyGlobalMedicalFileResponse.class);
      } else {
         ...
         responseMarshaller = new MarshallerHelper<T, T>(MsgResponse.class, MsgResponse.class);
      }
