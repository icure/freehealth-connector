...
public final class RequestObjectBuilderFactory {
   ...
   private static ConfigurableFactoryHelper<RequestObjectBuilder> helperFactoryrequestBuilder = new ConfigurableFactoryHelper<RequestObjectBuilder>("attestv2.requestobjectbuilder.class", "be.ehealth.businessconnector.mycarenet.attestv2.builders.impl.RequestObjectBuilderImpl");
   ...
   public static RequestObjectBuilder getRequestObjectBuilder() throws TechnicalConnectorException {
      return helperFactoryrequestBuilder.getImplementation();
   }
}
