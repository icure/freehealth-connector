...
public final class ResponseObjectBuilderFactory {
   ...
   private static ConfigurableFactoryHelper<ResponseObjectBuilder> helperFactoryresponseBuilder = new ConfigurableFactoryHelper<ResponseObjectBuilder>("attestv2.responseobjectbuilder.class", "be.ehealth.businessconnector.mycarenet.attestv2.builders.impl.ResponseObjectBuilderImpl");
