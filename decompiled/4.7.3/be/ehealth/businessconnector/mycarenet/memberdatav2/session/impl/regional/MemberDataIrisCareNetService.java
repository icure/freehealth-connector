...
public class MemberDataIrisCareNetService implements MemberDataService {
   private be.ehealth.businessconnector.mycarenet.memberdatav2.service.MemberDataService service;
   private SessionValidator sessionValidator;

   public MemberDataIrisCareNetService(SessionValidator sessionValidator) throws TechnicalConnectorException {
      this.service = new MemberDataServiceImpl(sessionValidator, "$uddi{uddi:ehealth-fgov-be:business:iriscarenetmemberdata:v1}");
