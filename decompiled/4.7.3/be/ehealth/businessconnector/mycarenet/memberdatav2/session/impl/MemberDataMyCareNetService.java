...
public class MemberDataMyCareNetService implements MemberDataService {
   private be.ehealth.businessconnector.mycarenet.memberdatav2.service.MemberDataService service;
   private SessionValidator sessionValidator;

   public MemberDataMyCareNetService(SessionValidator sessionValidator) throws TechnicalConnectorException {
      this.service = new MemberDataServiceImpl(sessionValidator);
