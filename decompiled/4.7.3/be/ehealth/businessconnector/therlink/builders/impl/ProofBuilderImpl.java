...
public class ProofBuilderImpl implements ProofBuilder {
   ...
   public Proof createProofForEidSigning(Credential cred) throws TherLinkBusinessConnectorException {
      return this.createProofForEidSigning(cred, (String)null);
   }

   public Proof createProofForEidSigning(Credential cred, String signatureAlgorithm) throws TherLinkBusinessConnectorException {
      ...
      try {
         ...
         this.addSignature(cred, proof, therapeuticLink, signatureAlgorithm);
         return proof;
      } catch (Exception e) {
   ...
   private void addSignature(Credential cred, Proof proof, TherapeuticLink therapeuticLink, String signatureAlgorithm) throws TherLinkBusinessConnectorException, TechnicalConnectorException {
      ...
      if (signatureAlgorithm != null) {
         options.put("signatureAlgorithm", signatureAlgorithm);
      }
