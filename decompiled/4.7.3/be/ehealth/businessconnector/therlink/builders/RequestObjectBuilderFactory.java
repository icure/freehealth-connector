...
public final class RequestObjectBuilderFactory {
   ...
   private static ConfigurableFactoryHelper<CommonObjectBuilder> helperFactoryCommonBuilder = new ConfigurableFactoryHelper<CommonObjectBuilder>("therlink.commonobjectbuilder.class", "be.ehealth.businessconnector.therlink.builders.impl.CommonObjectBuilderImpl");
   private static ConfigurableFactoryHelper<ProofBuilder> helperFactoryProofBuilder = new ConfigurableFactoryHelper<ProofBuilder>("therlink.proofbuilder.class", "be.ehealth.businessconnector.therlink.builders.impl.ProofBuilderImpl");
   private static ConfigurableFactoryHelper<RequestObjectBuilder> helperFactoryRequestObjectBuilder = new ConfigurableFactoryHelper<RequestObjectBuilder>("therlink.requestobjectbuilder.class", "be.ehealth.businessconnector.therlink.builders.impl.GenericRequestObjectBuilder");
   ...
   public static CommonObjectBuilder getCommonBuilder() throws TherLinkBusinessConnectorException, TechnicalConnectorException, InstantiationException {
      return helperFactoryCommonBuilder.getImplementation();
   }
   ...
   public static ProofBuilder getProofBuilder() throws TechnicalConnectorException, TherLinkBusinessConnectorException, InstantiationException {
      ...
      return helperFactoryProofBuilder.getImplementation();
   }
