...
import be.ehealth.technicalconnector.config.impl.ConfigurationWithSessionCache;
...
public final class SessionManagerImpl implements SessionManager {
   ...
   private final List<SessionServiceWithCache> cacheService;
   private final Semaphore mutex;
   private Cache<String, KeyStore> cache;
   private SessionItem session;
   private ConfigurationWithSessionCache config;
   ...
   private static void isEidPresent() throws TechnicalConnectorException {
      if (ConfigFactory.getConfigValidator().getBooleanProperty("sessionmanager.disable.eidpresent", false)) {
   ...
   private void bootstrapConfig() {
      this.config = new ConfigurationWithSessionCache(ConfigFactory.getConfigValidatorFor("sessionmanager.samlattribute", "sessionmanager.samlattributedesignator"));
   }
