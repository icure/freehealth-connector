...
public class ConfigurationModuleBootstrap implements ConfigurationModule {
   ...
   public void init(Configuration config) throws TechnicalConnectorException {
      ...
      for(String module : configuredModules) {
         try {
            ...
            LOG.warn("Unable to load module [" + module + "]", e);
         }
      }

      for(ModuleBootstrapHook module : registry) {
   ...
   private static ClassLoader getDefaultClassLoader() {
      ...
      try {
         ...
         LOG.debug("Cannot access thread context ClassLoader - falling back...", ex);
      }
      ...
      if (cl == null) {
         ...
         if (cl == null) {
            ...
            try {
               ...
               LOG.debug("Cannot access system ClassLoader - oh well, maybe the caller can live with null...", ex);
            }
         }
      }
