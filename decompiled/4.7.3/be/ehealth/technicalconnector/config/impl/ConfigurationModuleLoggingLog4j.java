   ...
   public void init(Properties config) {
      ...
      if (FALSE.equalsIgnoreCase(executed)) {
         ...
         if (configLogger) {
            ...
            var11 = new ByteArrayInputStream(configuration);
         } else {
            ...
            try {
               var11 = ConnectorIOUtils.getResourceAsStream(configLocation);
         ...
         try {
            ...
            configurator.doConfigure((InputStream)var11, LogManager.getLoggerRepository());
         } catch (Exception e) {
            throw new InstantiationException(e);
         }
