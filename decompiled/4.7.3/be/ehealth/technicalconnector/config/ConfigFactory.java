...
public final class ConfigFactory {
   ...
   public static void setLocation(InputStream is) throws TechnicalConnectorException {
      ...
      try {
         ...
         throw new TechnicalConnectorException(TechnicalConnectorExceptionValues.ERROR_IOEXCEPTION, new Object[]{"Problem with the temporary file inputstream.properties", e});
      } finally {
