...
public final class RevocationStatusCheckerFactory {
   ...
   private static ConfigurableFactoryHelper<RevocationStatusChecker> helper = new ConfigurableFactoryHelper<RevocationStatusChecker>("crypto.revocationstatuschecker.classname", "be.ehealth.technicalconnector.service.etee.impl.ConnectorRevocationStatusChecker");
