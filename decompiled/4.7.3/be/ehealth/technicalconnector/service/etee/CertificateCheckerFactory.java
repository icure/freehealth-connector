...
public final class CertificateCheckerFactory {
   ...
   private static ConfigurableFactoryHelper<CertificateChecker> helper = new ConfigurableFactoryHelper<CertificateChecker>("crypto.certificatechecker.classname", ConnectorCertificateChecker.class.getName());
