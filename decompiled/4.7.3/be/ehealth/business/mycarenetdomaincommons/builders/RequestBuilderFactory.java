...
public final class RequestBuilderFactory {
   ...
   private static ConfigurableFactoryHelper<BlobBuilder> blobBuilderFactory = new ConfigurableFactoryHelper<BlobBuilder>("mycarenet.blobbuilder.class", "be.ehealth.business.mycarenetdomaincommons.builders.impl.BlobBuilderImpl");
   ...
   private static ConfigurableFactoryHelper<CommonBuilder> commonBuilderFactory = new ConfigurableFactoryHelper<CommonBuilder>("mycarenet.commonbuilder.class", "be.ehealth.business.mycarenetdomaincommons.builders.impl.GenericCommonBuilderImpl");
   ...
   public static CommonBuilder getCommonBuilder(String projectName) throws TechnicalConnectorException {
      ...
      if (projectName == null) {
         ...
         return commonBuilderFactory.getImplementation(configParameters);
      }
   }
}
