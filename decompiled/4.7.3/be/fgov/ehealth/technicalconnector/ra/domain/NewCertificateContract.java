...
public class NewCertificateContract extends Request {
   ...
   private void verifyPKCS10(byte[] pkcs10, String dn) {
      ...
      Validate.isTrue(RaPropertiesLoader.getProperty("authentication.key.algorithm.oid").equals(pkInfo.getAlgorithm().getAlgorithm().getId()), "Public key was not RSA.", new Object[0]);
