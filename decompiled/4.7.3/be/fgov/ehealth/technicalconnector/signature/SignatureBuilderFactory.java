...
import be.fgov.ehealth.technicalconnector.signature.impl.xades.impl.XadesCSpecification;
...
public final class SignatureBuilderFactory {
   ...
   private static final Map<AdvancedElectronicSignatureEnumeration, SignatureBuilder> builders = new EnumMap(AdvancedElectronicSignatureEnumeration.class);
   ...
   static {
      ...
      try {
         ...
         if (builderList.isEmpty()) {
            ...
            processBuilder(new XmlSignatureBuilder(AdvancedElectronicSignatureEnumeration.XAdES_C, new XadesSpecification[]{new XadesBesSpecification(), new XadesTSpecification(), new XadesCSpecification()}));
