...
public final class ResponseObjectBuilderFactory {
   ...
   private static ConfigurableFactoryHelper<ResponseObjectBuilder> helperFactoryresponseBuilder = new ConfigurableFactoryHelper<ResponseObjectBuilder>("attest.responseobjectbuilder.class", "be.ehealth.businessconnector.mycarenet.attest.builders.impl.ResponseObjectBuilderImpl");
