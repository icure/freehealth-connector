...
class STSController(private val stsService: STSService, private val ssoService: SSOService) {
    ...
    fun getKeystoreInfo(
        @PathVariable(name = "keystoreId") keystoreId: UUID,
        @RequestHeader(name = "X-FHC-passPhrase") passPhrase: String,
        @RequestHeader(name = "X-Company", required = false, defaultValue = "NA") company: String,
        @RequestHeader(name = "X-FHC-debug", required = false, defaultValue = "false") debug: Boolean,
        @PathVariable(name = "quality") quality: String): CertificateInfo {
    ...
    fun requestToken(
        ...
        @RequestHeader(name = "X-Company", required = false, defaultValue = "NA") company: String,
        @RequestHeader(name = "X-FHC-debug", required = false, defaultValue = "false") debug: Boolean,
        @RequestParam(required = false) isMedicalHouse: Boolean?,
        @RequestParam(required = false) isGuardPost: Boolean?,
        @RequestParam(required = false) isSortingCenter: Boolean?,
        @RequestHeader(name = "X-FHC-tokenId", required = false) previousTokenId: UUID?
    ): SamlTokenResult? {
    ...
    fun requestToken(
        ...
        @RequestHeader(name = "X-Company", required = false, defaultValue = "NA") company: String,
        @RequestHeader(name = "X-FHC-debug", required = false, defaultValue = "false") debug: Boolean,
        @PathVariable(name = "quality") quality: String,
        @RequestHeader(name = "X-FHC-tokenId", required = false) previousTokenId: UUID?
    ): SamlTokenResult? {
    ...
    fun requestTokenInstitutions(
        ...
        @RequestHeader(name = "X-FHC-debug", required = false, defaultValue = "false") debug: Boolean,
        @PathVariable(name = "quality") quality: String,
        @PathVariable(name = "cbeNumber") cbeNumber: String,
        @RequestHeader(name = "X-FHC-tokenId", required = false) previousTokenId: UUID?
    ): SamlTokenResult? {
