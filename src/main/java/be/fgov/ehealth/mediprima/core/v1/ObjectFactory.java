 ...
 * generated in the be.fgov.ehealth.mediprima.core.v1 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: be.fgov.ehealth.mediprima.core.v1
     * 
     */
