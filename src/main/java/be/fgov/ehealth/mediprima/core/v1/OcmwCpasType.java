 ...
 *         &lt;element name="Name" type="{urn:be:fgov:ehealth:mediprima:core:v1}NameType" maxOccurs="unbounded" minOccurs="2"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "OcmwCpasType", namespace = "urn:be:fgov:ehealth:mediprima:core:v1", propOrder = {
    "cbeNumber",
    "municipalityIns",
    "name"
})
