 ...
 *         &lt;element name="PswcSupport" type="{urn:be:fgov:ehealth:mediprima:core:v1}PswcSupportType" minOccurs="0"/>
 *         &lt;element name="AmountPatientPartMax" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *         &lt;element name="AllowedSupplements" type="{urn:be:fgov:ehealth:mediprima:core:v1}AllowedSupplementsType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "MedicalCoverCommonInformationType", namespace = "urn:be:fgov:ehealth:mediprima:core:v1", propOrder = {
    "validityPeriod",
    "pswcSupport",
