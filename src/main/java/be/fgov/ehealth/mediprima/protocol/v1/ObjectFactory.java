...
public class ObjectFactory {
    ...
    private final static QName _ConsultCarmedInterventionResponse_QNAME = new QName("urn:be:fgov:ehealth:mediprima:protocol:v1", "ConsultCarmedInterventionResponse");
    private final static QName _Status_QNAME = new QName("urn:be:fgov:ehealth:commons:core:v2", "Status");
    private final static QName _MedicalCardRegistryStatus_QNAME = new QName("urn:be:fgov:ehealth:mediprima:core:v1", "MedicalCardRegistryStatus");
    ...
    private final static QName _ConsultCarmedInterventionRequest_QNAME = new QName("urn:be:fgov:ehealth:mediprima:protocol:v1", "ConsultCarmedInterventionRequest");
    private final static QName _CbssStatus_QNAME = new QName("urn:be:fgov:ehealth:mediprima:core:v1", "CbssStatus");
