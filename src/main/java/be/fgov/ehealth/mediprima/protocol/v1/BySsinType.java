 ...
 *         &lt;choice>
 *           &lt;element name="Period" type="{urn:be:fgov:ehealth:mediprima:core:v1}PeriodType"/>
...
@XmlType(name = "BySsinType", namespace = "urn:be:fgov:ehealth:mediprima:core:v1", propOrder = {
    "ssin",
    "period",
    "referenceDate"
})
