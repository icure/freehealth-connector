 ...
 *       &lt;sequence>
 *         &lt;element name="Detail" type="{urn:be:cin:mycarenet:1.0:carenet:types}DetailType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "DetailsType", namespace = "urn:be:cin:mycarenet:1.0:carenet:types", propOrder = {
    "detail"
})
public class DetailsType {

    @XmlElement(name = "Detail", namespace = "urn:be:cin:mycarenet:1.0:carenet:types")
