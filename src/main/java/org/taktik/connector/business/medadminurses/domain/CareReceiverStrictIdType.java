...
/**
 * <p>Java class for CareReceiverStrictIdType complex type.
 * 
...
@XmlType(name = "CareReceiverStrictIdType", namespace = "urn:be:cin:mycarenet:1.0:carenet:types", propOrder = {
    "inss",
    "regNrWithMut",
    "mutuality"
})
@XmlSeeAlso({
    ExtCareReceiverStrictIdType.class
})
public class CareReceiverStrictIdType {
    ...
    @XmlElement(name = "Mutuality", namespace = "urn:be:cin:mycarenet:1.0:carenet:types", required = true)
