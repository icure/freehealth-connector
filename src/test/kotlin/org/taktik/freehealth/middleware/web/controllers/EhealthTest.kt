...
open class EhealthTest {
    ...
    */
    ...
    @Value("\${org.taktik.icure.keystore6.cbe}") var cbe6: String? = null
    ...
    @Value("\${org.taktik.icure.keystore6.nihii}") var nihii6: String? = null
    ...
    @Value("\${org.taktik.icure.keystore6.ssin}") var ssin6: String? = null
    ...
    @Value("\${org.taktik.icure.keystore6.password}") var password6: String? = null
    ...
    @Value("\${org.taktik.icure.keystore6.name}") var name6: String? = null
    ...
    @Value("\${org.taktik.icure.keystore6.firstName}") var firstName6: String? = null
    ...
    @Value("\${org.taktik.icure.keystore6.lastName}") var lastName6: String? = null
    ...
    @Value("\${org.taktik.icure.keystore6.BIC}") var BIC6: String? = null
    ...
    @Value("\${org.taktik.icure.keystore6.IBAN}") var IBAN6: String? = null
